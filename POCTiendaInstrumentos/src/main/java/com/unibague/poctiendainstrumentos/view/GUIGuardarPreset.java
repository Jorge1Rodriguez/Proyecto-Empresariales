 ...
 * @author gerca
 */
public class GUIGuardarPreset extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUIGuardarPreset.class.getName());
     ...
     */
    public GUIGuardarPreset(IServicioInstrumento servicioInstrumento) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtCodigo.getText().isBlank() || txtNombre.getText().isBlank()) {
            ...
            JOptionPane.showMessageDialog(this, teclado.guardarPreset(txtNombre.getText()));
            txtCodigo.setText("");
            txtNombre.setText("");
        }
